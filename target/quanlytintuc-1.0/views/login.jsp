	...
	<div class="wrap-login100">
		<form id="formLogin" class="login100-form validate-form"
			...
			<c:if test="${not empty message}">
				<div
					class="alert alert-${alert} alert-dismissible fade show au-alert au-alert--70per"
					role="alert">
					<i class="zmdi zmdi-check-circle"></i> <span class="content">${message}</span>
			...
			<div class="wrap-input100 validate-input"
				...
				<input class="input100" type="password" name="matKhau"> <span
