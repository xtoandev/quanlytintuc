	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="table-data__tool">
				...
				<div class="table-data__tool-right">
					<a class="au-btn au-btn-icon au-btn--green au-btn--small"
						href="<c:url value='/admin-baiviet?type=edit' />"> <i
						class="zmdi zmdi-plus"></i>Thêm bài viết
					</a>
					<button id="btnDelete" type="button"
						class="au-btn au-btn-icon  au-btn--small btn-danger">
						<i class="zmdi zmdi-delete"></i>Xoá bài viết
					</button>
				</div>
			</div>
			<div class="table-responsive table-responsive-data2">
						...
						<c:forEach items="${model.listData}" var="o" varStatus="loop">
							<tr class="tr-shadow">
								<td><label class="au-checkbox"> <input
										type="checkbox" id="checkbox_${o.maBaiViet}"
										value="${o.maBaiViet}"> <span class="au-checkmark"></span>
								</label></td>
								<td id="${o.maBaiViet}" scope="row">${(loop.index + 1) + (model.page - 1)* model.getMaxPageItems() }
								</th>
								...
								<td><c:url var="editURL" value="/admin-baiviet">
										<c:param name="type" value="edit" />
										<c:param name="maTaiKhoan" value="${item.maTaiKhoan}" />
									</c:url> <c:url var="detailURL" value="/admin-baiviet">
										<c:param name="type" value="detail" />
										<c:param name="maTaiKhoan" value="${item.maTaiKhoan}" />
									</c:url>
									<div class="table-data-feature">
										<a target="_blank"
											href="<c:url value='/bai-viet?mabaiviet=${o.maBaiViet}'/>"
											class="item" data-toggle="tooltip" data-placement="top"
											title="" data-original-title="Send"> <i class="fa fa-eye"></i>
										</a> <a
											href="<c:url value='/admin-baiviet?type=edit&maBaiViet=${o.maBaiViet}'/>"
											class="item" data-toggle="tooltip" data-placement="top"
				...
				<form id="formPaging" action="<c:url value='/admin-baiviet'/>"
					method="get">
