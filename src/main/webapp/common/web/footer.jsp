...
<div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
                ...
                <c:forEach items="${baivietmoi.listData}" var="o" varStatus="loop">
                	<c:if test="${ loop.index < 4 }">
	                	<div class="mb-3">
		                    ...
		                    <a class="small text-body text-uppercase font-weight-medium" href="<c:url value='/bai-viet?mabaiviet=${o.maBaiViet}' />">${o.tieuDe }</a>
		                </div>
                	</c:if>
                </c:forEach>
            </div>
            <div class="col-lg-2 col-md-6 mb-5">
                ...
                <div class="m-n1">
                	<c:forEach items="${dschude}" var="o" varStatus="loop">
                     	<a href="<c:url value='/chu-de?machude=${o.maChuDe}' />" class="btn btn-sm btn-secondary m-1">${o.tenChuDe}</a>
                    </c:forEach>                    
                </div>
            </div>
                 ...
                 <!-- Newsletter Start -->
	                    <div class="mb-3">
	                        <div class="section-title mb-0">
	                            <h4 class="m-0 text-uppercase font-weight-bold">Nhận thông báo!</h4>
	                        </div>
	                        <div class="bg-white text-center border border-top-0 p-3">
	                            <p>Nhập vào địa chỉ email để nhận thông báo mới nhất từ chúng tôi.</p>
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111;">
        <p class="m-0 text-center">&copy; <a href="<c:url value='/trang-chu' />">PXT Blog</a>. All Rights Reserved. 
    </div>